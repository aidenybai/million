...
After capturing the renders, we extended the compiler to asynchronously collect bundle, network, and state manager information without build time overhead.

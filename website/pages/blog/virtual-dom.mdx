...
This step is responsible for extracting dynamic parts of the virtual DOM into a the Edit Map.
...
Notice how there is a limitation how the application UI can be structured.

...
<Callout type="warning">
  If you have a CRA ([Create React App](https://create-react-app.dev/)) Setup, you will need to have [Craco](https://craco.js.org/docs/getting-started/) configured before proceeding
</Callout>
...
<p className="font-normal text-base">Checkout <a href="/docs/automatic">Automatic Mode</a> to learn about the mechanisms behind Automatic mode.</p>
</Tab>

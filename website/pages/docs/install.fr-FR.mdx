...
Million.js suppose que vous avez un projet React existant. Pour apprendre comment créer une application React, consultez la [documentation de React](https://react.dev).

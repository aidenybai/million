...
automatically with literally one parameter, checkout [Automatic Mode](/docs/install#configure-it-yourself) to set up Million.js in your project or just check out the [Installation Guide](/docs/install) to get started right away.
...
If you have questions or need clarity on things at this point, please feel free to ask them in the `questions` channel on the [Discord](https://discord.gg/7ZAGgTQVTE) or check out <Link href="/blog/million-beyond-speed">Million Beyond "Speed"</Link>

...
`useList` leverages a highly reactive data structure called a <Link href="/docs/api/advanced/delta">Delta</Link> to update the Virtual DOM. This makes it possible to update the DOM without having to go through traditional Virtual DOM diffing.

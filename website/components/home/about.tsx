            ...
            <div className="md:w-7/12 lg:w-1/2">
              ...
              <div className="divide-y space-y-4 divide-zinc-100 dark:divide-zinc-800">
                <div className="mt-8 flex gap-4 md:items-center">
                  <div className="w-12 h-12 flex gap-4 rounded-full bg-purple-100 dark:bg-purple-900/20">
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-6 h-6 text-purple-400 m-auto"
                    >
                      <path
                        strokeLinecap="round"
                ...
                <div className="pt-4 flex gap-4 md:items-center">
                  <div className="w-12 h-12 flex gap-4 rounded-full bg-purple-100 dark:bg-teal-900/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-6 h-6 m-auto text-purple-600 dark:text-purple-400"
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
      ...
      <div>
        <Container>
          ...
          <div className="relative mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-b from-zinc-200 to-white p-px dark:from-zinc-700 dark:via-zinc-800 dark:to-darker">
              <div className="relative flex h-full flex-col gap-6 rounded-2xl bg-zinc-100 p-8 dark:bg-zinc-900">
                ...
                <div>
                  ...
                  <p className="mt-3 text-zinc-600 dark:text-zinc-400">
                    Million.js introduces a novel "block" virtual DOM. It's
                    significantly faster than React's virtual DOM, as it diffs
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-b from-zinc-200 to-white p-px dark:from-zinc-700 dark:via-zinc-800 dark:to-darker">
              <div className="relative flex h-full flex-col gap-6 rounded-2xl bg-zinc-100 p-8 dark:bg-zinc-900">
                ...
                <div>
                  ...
                  <p className="mt-3 text-zinc-600 dark:text-zinc-400">
                    Million.js uses a custom compiler that automatically
                    optimizes your React components on the server.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative flex h-full flex-col gap-6 rounded-2xl bg-zinc-100 p-8 dark:bg-zinc-900">
                ...
                <div>
                  ...
                  <p className="mt-3 text-zinc-600 dark:text-zinc-400">
                    ...
                    Million.js ships one powerful function that you can use to

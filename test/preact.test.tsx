...
describe.concurrent('block', () => {
  ...
  it('should mount block', () => {
    ...
    expect(main.l?.outerHTML).toEqual(
      '<div><h1>Hello</h1> Preact<p title="baz" class="bar">foo</p></div>',
    );
  });
  it('should patch block', () => {
    ...
    expect(main.l?.outerHTML).toEqual(
      '<div><h1>Hello</h1> Preact<p title="baz" class="foo">bar</p></div>',
    );
    main.p(block({ foo: 'bar', bar: 'bar' }));
    expect(main.l?.outerHTML).toEqual(
      '<div><h1>Hello</h1> Preact<p title="baz" class="bar">bar</p></div>',
    );
  });
  it('should patch nested blocks', () => {
    ...
    expect(main.l?.outerHTML).toEqual(
      '<div><h1>Hello</h1> Preact<p title="baz" class="bar"><div><h1>Hello</h1> Preact<p title="baz" class="1">2</p></div></p></div>',
    );
  });
  ...
  it('should ignore null, undefined, false', () => {
    ...
    main.m();
    expect(main.l?.outerHTML).toEqual(
      '<div><h1>Hello</h1> Preact<p title="baz" class="bar"></p></div>',
    );

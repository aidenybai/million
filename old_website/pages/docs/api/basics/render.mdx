...
The `render` function is a combination of the `patch()` and `createElement()` functions. It takes a parent element and a vnode and returns a DOM node, and renders the vnode into the DOM.

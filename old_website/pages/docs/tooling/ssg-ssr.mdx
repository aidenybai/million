...
If you are considering writing a compiler for your Million library, consider taking a look at the implemenation of [`vite-plugin-million`](https://github.com/aidenybai/million/tree/v1.7.0/packages/vite-plugin-million). Additionally, you should look into [recast](https://github.com/benjamn/recast) and [ast-types](https://github.com/benjamn/ast-types), both great options for JavaScript AST traversal for static analysis. The reference for the AST can be found with the [ESPrima documentation](https://docs.esprima.org/en/latest/)
